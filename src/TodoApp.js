...
const GET_TASKS_API_BASE_URL = 'http://get-task.shivesh.online';
const DELETE_TASK_API_BASE_URL = 'http://delete-task.shivesh.online';
const CREATE_TASK_API_BASE_URL = 'http://add-task.shivesh.online';
